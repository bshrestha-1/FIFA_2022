/* t001_total_goals_by_team — adapted from FIFA2022_analysis.sas (lines 44-103) in this repo.
...
proc sort data=work.import_fifa;
    by team1;
run;

proc means data=work.import_fifa noprint sum;
    by team1;
    var goals_team1;
