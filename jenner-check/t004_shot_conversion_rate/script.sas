/* t004_shot_conversion_rate — adapted from FIFA2022_analysis.sas (lines 268-325) in this repo.
...
proc sort data=conversion_analysis;
    by team1;
run;

proc means data=conversion_analysis noprint mean;
    by team1;
...
proc sort data=total_conversion_rate;
    by descending conversion_rate;
run;

proc print data=total_conversion_rate;
