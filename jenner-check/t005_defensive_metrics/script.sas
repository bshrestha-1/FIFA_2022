/* t005_defensive_metrics — adapted from FIFA2022_analysis.sas (lines 337-418) in this repo.
...
run;
data defensive_metrics;
    set work.import_fifa;
    clean_sheet_team1 = (goals_team2 = 0);
    clean_sheet_team2 = (goals_team1 = 0);
run;

proc sort data=defensive_metrics;
    by team1;
run;

proc means data=defensive_metrics noprint sum;
    by team1;
...
proc sort data=total_defensive_metrics;
    by descending defensive_performance_score;
run;

proc print data=total_defensive_metrics;
